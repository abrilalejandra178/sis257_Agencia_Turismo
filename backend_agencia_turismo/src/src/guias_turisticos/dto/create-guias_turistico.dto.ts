...
export class CreateGuiasTuristicoDto {
  ...
  @IsArray({ message: 'El idioma debe ser un arreglo' })
  @ArrayNotEmpty({ message: 'Debe seleccionar al menos un idioma' })
  @IsIn(['Español', 'Inglés', 'Francés', 'Alemán', 'Portugués', 'Quechua'], {
    each: true,
